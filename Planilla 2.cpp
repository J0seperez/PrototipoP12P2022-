...
void menuSistema() {
	...
	printf("\t\t    Sistema Corporacion  Comercial\n");
	printf("\t\t   Jose Perez |9959-21-4557\n");
	printf("     ======================================================================\n");
...
void persona::menu()
{
	...
	cout<<"\t\t\t-------------------------------"<<endl;
	cout<<"\t\t\t 1. Ingreso Nombre cliente/Proveedor:"<<endl;
	cout<<"\t\t\t 2. Despliegue Informacion cliente/Proveedor:"<<endl;
	cout<<"\t\t\t 3. Modificar cliente/Proveedor:"<<endl;
	cout<<"\t\t\t 4. Buscar cliente/Proveedor:"<<endl;
	cout<<"\t\t\t 5. Borrar cliente/Proveedor:"<<endl;
    cout<<"\t\t\t 6 Exit"<<endl;
...
void persona::insert()
{
	...
	cout<<"\t\t\tIngresa  ID cliente/Provedor:      : ";
	cin>>id;
	cout<<"\t\t\tIngresa Nombre cliente/Provedor:     : ";
	cin>>name;
	cout<<"\t\t\tIngresa Numero de cliente/Provedor:   : ";
	cin>>phone;
	cout<<"\t\t\tIngresa Empresa cliente/Provedor:: ";
	cin>>college;
	cout<<"\t\t\tIngresa Direccion cliente/Provedor: ";
	cin>>address;
...
void persona::display()
{
	...
	else
	{
		...
		{
			total++;
			cout<<"\n\n\t\t\t Id cliente/Provedor:: "<<id<<endl;
			cout<<"\t\t\t Nombre cliente/Provedor: "<<name<<endl;
			cout<<"\t\t\t Telefono cliente/Provedor:"<<phone<<endl;
			cout<<"\t\t\t Empresa cliente/Provedor: "<<college<<endl;
			cout<<"\t\t\t Direccion cliente/Provedor: "<<address<<endl;
			file >> id >> name >> phone >> college >> address;
		}
		if(total==0)
		{
...
void persona::modify()
{
	...
	else
	{
		...
		while(!file.eof())
		{
			...
			{
				cout<<"\t\t\tIngrese Id cliente/Provedor: ";
				cin>>id;
				cout<<"\t\t\tIngrese Nombre cliente/Provedor: ";
				cin>>name;
				cout<<"\t\t\tIngrese Telefono cliente/Provedor: ";
				cin>>phone;
				cout<<"\t\t\tIngrese Empresa cliente/Provedor:";
				cin>>college;
				cout<<"\t\t\tIngrese Direccion cliente/Provedor: ";
				cin>>address;
				file1<<std::left<<std::setw(15)<< id <<std::left<<std::setw(15)<< name <<std::left<<std::setw(15)<< phone <<std::left<<std::setw(15)<< college <<std::left<<std::setw(15)<< address << "\n";
				found++;
		//hora();
